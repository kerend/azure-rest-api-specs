...
These settings apply only when `--tag=package-preview-2017-07` is specified on the command line.

```yaml $(tag) == 'package-preview-2017-07'
input-file:
  - Microsoft.Security/preview/2017-07-01-preview/customAssessmentAutomation.json
  - Microsoft.Security/preview/2017-07-01-preview/customEntityStoreAssignment.json
```
